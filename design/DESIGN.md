...
| **Quick links** (Home's rail: Content sort, Newsletter, Share something, Listserv sign-up) | one FA glyph each, accent | white 12px card, Outfit title over a muted line; Open ↗ and Copy as small outlined pills on their own line | the team's four ways out of the main page (Kate's Sep 15 sketch, layout A); Copy hands over one sentence with the link |
