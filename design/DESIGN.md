...
The share form and the listserv sign-up live on the Policy Exchange's address (/share/ and /newsletter/), not the desk's. Copies at the desk's /submit and /listserv were built and taken down on Sep 22: the desk has no password, and a public page on its address is a door into it (Kate: "I don't want others to backspace from submit and see everything"). If they ever come back, they take an address of their own. The bot check still honours a body marked `public: true`. The public share page is deliberately NOT the desk theme: it wears the ERC's outward maroon, the listserv sign-up's look (Work Sans/Open Sans, white card with the 3px #500000 border and hard offset shadow, uppercase maroon button), because it faces the public alongside the newsletter and the hub. It never links into the desk. Uniformity audits should hold it against the sign-up page, not against the desk tokens.
